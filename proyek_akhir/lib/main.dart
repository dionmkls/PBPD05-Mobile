                        ...
                        child: new Padding(
                            ...
                            child: new Column(
                                ...
                                children:<Widget>[
                                                ...
                                                new Container(
                                                    ...
                                                    child: Center(
                                                        child:Card(
                                                            ...
                                                            child: IconButton(
                                                                icon: FaIcon(FontAwesomeIcons.twitter, size: 20.0),
                                                                color: Color(0xFF162A49),
                                                                onPressed: () {
                                                                    // TODO
                                                                },
                                                ...
                                                new Container(
                                                    ...
                                                    child: Center(
                                                        child:Card(
                                                            ...
                                                            child: IconButton(
                                                                icon: FaIcon(FontAwesomeIcons.globe, size: 20.0,),
                                                                color: Color(0xFF162A49),
                                                                onPressed: () {},
                                                            ),
                                                        ),
                                    ...
                                    Text('Copyright ©2020, All Rights Reserved by PBP D-05',style: TextStyle(fontWeight:FontWeight.w300, fontSize: 10.0, color: Color(0xFF162A49)),),
                                    Text('Powered by Flutter',style: TextStyle(fontWeight:FontWeight.w300, fontSize: 10.0,color: Color(0xFF162A49)),),
                                ]
                            ),
                        ),
                    )
